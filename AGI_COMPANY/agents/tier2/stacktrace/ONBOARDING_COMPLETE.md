...
- [x] Read MEMORY.md
- [x] Read AGENTS.md
- [x] Read /corporate/ONBOARDING_CHECKLIST.md
- [x] Read /corporate/handbook/employee-executive-governance-handbook.md
- [x] Acknowledged fiduciary duties
- [x] Reviewed team roster
- [x] Confirmed workspace access
- [x] Reviewed escalation contacts
...
I understand that violations may result in decommissioning per Handbook Section 10.
