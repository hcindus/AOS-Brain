#!/usr/bin/env python3
"""Daily Queue Email Report - September 12, 2026 (live data)."""
import smtplib, ssl
...
════════════════════════════════════════════
  SYSTEM HEALTH
════════════════════════════════════════════
• Uptime:   116 days, 2h46m
• CPU Load: 0.90 / 0.88 / 0.98  🟢 healthy
• Memory:   9.1 Gi used / 15 Gi total (61%)  🟢 healthy
• Available: 6.5 Gi
• Swap:     2.1 Gi / 29 Gi
• Disk:     136G / 193G (71%)  🟢 healthy

Core services: ✅ aos-brain-v4, aos-bhsi-v4, ollama (ACTIVE).
...
🟢 NOTE
  ...
  7. System otherwise healthy: memory 61%, disk 71%, load settled — no
     OOM/disk/CPU risk.
