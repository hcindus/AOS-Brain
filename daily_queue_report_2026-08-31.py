#!/usr/bin/env python3
"""Daily Queue Email Report - August 31, 2026 (live data)."""
import smtplib, ssl
...
════════════════════════════════════════════
  SYSTEM HEALTH
════════════════════════════════════════════
• Uptime:   104 days, 2h46m
• CPU Load: 1.94 / 1.80 / 1.81  🟢 healthy
• Memory:   6.0 Gi used / 15 Gi total (40%)  🟢 healthy
• Available: 9.6 Gi
• Swap:     5.3 Gi / 29 Gi
...
🟢 NOTE
  ...
  4. System healthy: load ~1.9, memory 40%, disk 69% — no OOM/disk risk.
