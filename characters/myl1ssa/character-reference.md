...
| Vibe | High-end, effortless elegance |
| Settings | Night city street (blurred traffic/lights) · modern plush interior |
...
1. **Front close-up** — `Master Likeness Anchor` + `Front-facing close-up portrait, head and shoulders, holding the champagne glass, looking at the camera.`
2. **Three-quarter view** — `Master Likeness Anchor` + `Three-quarter view, turned slightly to the side, relaxed elegant posture.`
3. **Left side profile** — `Master Likeness Anchor` + `Left side profile, facing the viewer's left, clean silhouette of the short hair, dress, and fur coat.`
4. **Right side profile** — `Master Likeness Anchor` + `Right side profile, facing the viewer's right, matching the left-profile likeness exactly.`
5. **Medium / upper-body shot** — `Master Likeness Anchor` + `Medium shot, waist-up, champagne in hand, ready for reuse as a consistent character reference.`
...
- **Pixie bob (alternate hair)** — `Photorealistic portrait of Myl1Ssa, a glamorous woman with a short dark pixie-bob haircut. Elegant black dress and dark fur coat, holding champagne. Warm cinematic lighting. Same face as the long-haired Myl1Ssa — an intentional alternate short-hair look.`
