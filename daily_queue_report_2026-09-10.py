#!/usr/bin/env python3
"""Daily Queue Email Report - September 10, 2026 (live data)."""
import smtplib, ssl
...
════════════════════════════════════════════
  SYSTEM HEALTH
════════════════════════════════════════════
• Uptime:   113 days, 21h08m
• CPU Load: 1.11 / 0.95 / 0.92  🟢 healthy
• Memory:   9.7 Gi used / 15 Gi total (65%)  🟢 healthy
• Available: 6.0 Gi
• Swap:     1.7 Gi / 29 Gi
• Disk:     135G / 193G (70%)  🟢 healthy

Core services: ✅ aos-brain-v4, aos-bhsi-v4, depotchaos, ollama,
darkfactory-worker, collections-worker, legal-worker, media-worker,
psd-sales-automation, testimonials-api, mission-control (ACTIVE).
...
🟡 IMPORTANT
  ...
  3. society-agents.service remains disabled/inactive.
