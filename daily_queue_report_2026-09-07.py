#!/usr/bin/env python3
"""Daily Queue Email Report - September 7, 2026 (live data)."""
import smtplib, ssl
...
════════════════════════════════════════════
  SYSTEM HEALTH
════════════════════════════════════════════
• Uptime:   110 days, 21h08m
• CPU Load: 2.20 / 2.01 / 1.95  🟢 healthy (brief 06:00 cron spike)
...
🟢 NOTE
  ...
  6. System otherwise healthy: memory 57%, disk 69%, load settled —
